...
public class Pigeon {
  ...
  public static class LocationMessage {
    ...
    public @Nullable Double getDirection() { return direction; }
  ...
  public interface Api {
    ...
    void wifiState(Result<Long> result);
    void btExtendedSupported(Result<Boolean> result);
    void btMaxAdvDataLen(Result<Long> result);
    void wifiNaNSupported(Result<Boolean> result);
    ...
    static void setup(BinaryMessenger binaryMessenger, Api api) {
      ...
      {
        BasicMessageChannel<Object> channel =
            new BasicMessageChannel<>(binaryMessenger, "dev.flutter.pigeon.Api.wifiState", getCodec());
        if (api != null) {
          channel.setMessageHandler((message, reply) -> {
            Map<String, Object> wrapped = new HashMap<>();
            try {
      ...
      {
        BasicMessageChannel<Object> channel =
            new BasicMessageChannel<>(binaryMessenger, "dev.flutter.pigeon.Api.btExtendedSupported", getCodec());
        if (api != null) {
          channel.setMessageHandler((message, reply) -> {
            Map<String, Object> wrapped = new HashMap<>();
            try {
      ...
      {
        BasicMessageChannel<Object> channel =
            new BasicMessageChannel<>(binaryMessenger, "dev.flutter.pigeon.Api.btMaxAdvDataLen", getCodec());
        if (api != null) {
          channel.setMessageHandler((message, reply) -> {
            Map<String, Object> wrapped = new HashMap<>();
            try {
      ...
      {
        BasicMessageChannel<Object> channel =
            new BasicMessageChannel<>(binaryMessenger, "dev.flutter.pigeon.Api.wifiNaNSupported", getCodec());
        if (api != null) {
          channel.setMessageHandler((message, reply) -> {
            Map<String, Object> wrapped = new HashMap<>();
            try {
      ...
      } else 
{
  ...
  public interface MessageApi {
    @Nullable Long determineMessageType(@NonNull byte[] payload, @NonNull Long offset);
    @Nullable BasicIdMessage fromBufferBasic(@NonNull byte[] payload, @NonNull Long offset, @NonNull String macAddress);
    @Nullable LocationMessage fromBufferLocation(@NonNull byte[] payload, @NonNull Long offset, @NonNull String macAddress);
    @Nullable OperatorIdMessage fromBufferOperatorId(@NonNull byte[] payload, @NonNull Long offset, @NonNull String macAddress);
    @Nullable SelfIdMessage fromBufferSelfId(@NonNull byte[] payload, @NonNull Long offset, @NonNull String macAddress);
    @Nullable AuthenticationMessage fromBufferAuthentication(@NonNull byte[] payload, @NonNull Long offset, @NonNull String macAddress);
    @Nullable SystemDataMessage fromBufferSystemData(@NonNull byte[] payload, @NonNull Long offset, @NonNull String macAddress);
    @Nullable ConnectionMessage fromBufferConnection(@NonNull byte[] payload, @NonNull Long offset, @NonNull String macAddress);
