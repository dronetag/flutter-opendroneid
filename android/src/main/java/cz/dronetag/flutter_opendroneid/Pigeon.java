      ...
      } else 
{
  ...
  public interface MessageApi {
    @Nullable Long determineMessageType(byte[] payload, Long offset);
    @Nullable BasicIdMessage fromBufferBasic(byte[] payload, Long offset, String macAddress);
    @Nullable LocationMessage fromBufferLocation(byte[] payload, Long offset, String macAddress);
    @Nullable OperatorIdMessage fromBufferOperatorId(byte[] payload, Long offset, String macAddress);
    @Nullable SelfIdMessage fromBufferSelfId(byte[] payload, Long offset, String macAddress);
    @Nullable AuthenticationMessage fromBufferAuthentication(byte[] payload, Long offset, String macAddress);
    @Nullable SystemDataMessage fromBufferSystemData(byte[] payload, Long offset, String macAddress);
    @Nullable ConnectionMessage fromBufferConnection(byte[] payload, Long offset, String macAddress);
